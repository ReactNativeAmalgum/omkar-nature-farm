...
function ContectPage() {
  return (
    <>
      {/* <MetaTags>
        <title>Farmstay near Wada | Omkar Nature Farm</title>
        <meta title="Farmstay near Wada | Omkar Nature Farm" />
        ...
        <meta property="og:title" content="Farmstay near Wada | Omkar Nature Farm" />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://omkarnaturefarm.in/" />
        <meta property="og:description" content="At the Farmstay near Wada, experience serene retreats amidst nature's embrace. Leave the city behind and immerse yourself in tranquility." />
